    ...
    <div className="sm:flex items-center justify-between py-8 space-y-6 sm:space-y-0 sm:space-x-4">
      ...
      {prevArticle && prevArticle[1] && (
        <div className="sm:w-1/2 sm:flex flex-col items-start">
          <div>
            <div className="text-xs font-[650] text-blue-600 uppercase mb-1">
              Prev
            </div>
            <div>
              <Link
                className="text-slate-800 font-[650] flex items-center dark:text-slate-200"
                href={prevArticle[1]}
              >
                <svg
                  className="fill-slate-400 shrink-0 mr-2 rotate-180 dark:fill-slate-500"
                  width="8"
                  height="10"
          ...
          <div>
            ...
            <div>
              ...
              >
                ...
                <svg
                  className="fill-slate-400 shrink-0 ml-2 dark:fill-slate-500"
                  width="8"
                  height="10"
                  xmlns="http://www.w3.org/2000/svg"
                >
