...
export default function SupportSidebar() {
  ...
  return (
    <div>
      {/* Backdrop */}
      <div
        className={`md:hidden fixed inset-0 bg-slate-900/20 z-10 lg:hidden lg:z-auto transition-opacity duration-200 ${sidebarOpen ? "opacity-100" : "opacity-0 pointer-events-none"
          }`}
        aria-hidden="true"
      ></div>
      ...
      <aside
        ref={sidebar}
        id="sidebar"
        className={`fixed left-0 top-0 bottom-0 w-64 h-screen border-r border-slate-200 md:left-auto md:shrink-0 z-10 dark:border-slate-800 dark:bg-slate-900 transform transition-transform ease-out duration-200 ${sidebarOpen
                  ...
                  {(handleClick, open) => {
                    return (
                      <>
                        <a
                          href="#0"
                          className={`relative flex items-center font-[650] text-slate-800 p-1 before:absolute before:inset-0 before:rounded-sm  before:from-blue-400 before:to-purple-500 before:opacity-20 before:-z-10 before:pointer-events-none dark:text-slate-200 "
                          }`}
                        >
                          <svg
                          ...
                          <span>Hogyan használljuk a SzókincsAktivátort?</span>
                        </a>
                        <ul
                        ...
                        >
                          <li className="mt-3">
                            <SidebarLink href="/documentation/introduction">
                              Mire jó a SzókincsAktivátor?
                            </SidebarLink>
                          </li>
                          <li className="mt-3">
                            <SidebarLink href="/documentation/access">
                              A SzókincsAktivátor elindítása
                            </SidebarLink>
                          </li>
                          <li className="mt-3">
                            <SidebarLink href="/documentation/newwords">
                              Új szavak hozzáadása
                            </SidebarLink>
                          </li>
                          <li className="mt-3">
                            <SidebarLink href="/documentation/study">
                              Tanulás a SzókincsAktivátorral
                            </SidebarLink>
                          </li>
                          <li className="mt-3">
                            <SidebarLink href="/documentation/vocabulary">
                              A szókincsed
                            </SidebarLink>
                          </li>
                          <li className="mt-3">
                            <SidebarLink href="/documentation/progress">
                              Haladás
                            </SidebarLink>
                          </li>
                  ...
                  {(handleClick, open) => {
                    return (
                      <>
                        <a
                          href="#0"
                          className={`relative flex items-center font-[650] text-slate-800 p-1 before:absolute before:inset-0 before:rounded-sm before:bg-linear-to-tr before:from-blue-400 before:to-purple-500 before:opacity-20 before:-z-10 before:pointer-events-none dark:text-slate-200 ${
